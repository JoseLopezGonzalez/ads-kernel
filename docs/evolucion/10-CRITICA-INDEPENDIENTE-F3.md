...
| `O13` | primera matriz de entornos agentic | **cierra la pregunta 8**. Claude Code y Codex como objetivo soportado y certificado; Cursor y Gemini presentes desde el diseño en nivel compatible o genérico hasta pasar su prueba de humo; fallback genérico obligatorio. **Ningún soporte se declara sin ejecución real** |

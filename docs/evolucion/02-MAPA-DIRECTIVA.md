...
| 8 | gobierno Git del proyecto real | **AUSENTE** | sólo `G29` en la prosa de 1.3.0. Ninguna de las treinta materias del 8.1 tiene propietario, método, gate ni evidencia |

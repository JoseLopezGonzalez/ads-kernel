...
| 49 | `kernel/operativo/capacidades/CNS/CAPACIDAD.md` | 107 | `e0f79e6c3a467302c3d16aa5ee4ccb45583daf146d1676b2b06995419656c5d5` | ii | **DELEGADA** | AGOTADA POR DELEGACIÓN · su SHA-256 lo publicó el manifiesto `B` del documento **31** · árbol `2e31452`. **Nadie declaró haberla leído íntegra en aquel gate** |

# MANIFIESTO PREVIO DE ASIGNACIÓN — GATE FINAL DE `F4c`, EL PRIMERO BAJO `O21`
...
ADJUDICADOR `ADJ` recibe los DOS dictámenes YA CERRADOS, reproduce sus afirmaciones contra
...
INDEPENDENCIA     ninguno de los tres ha escrito F4, aplicado ninguna corrección, ni
                  ...
                  PARALELO y SIN VERSE; `ADJ` no ve nada hasta que los dos cierran.
...
| 3 | `docs/evolucion/30-GATE-ARQUITECTONICO-FINAL-F4C.md` | 3084 | `712058b2467287d7ca51380cf305e84ac311f141d1c12ec0649c8b901aee6503` | iv | **W1+W2+ADJ** | los tres · DESPUÉS de las demás fuentes: es el gate cuyos dieciséis hallazgos se juzgan |
...
| 9 | `docs/owner/ADS-OWNER-RESOLUCIONES.md` | 559 | `ebfef288de70d1ec6d58306720440b9a4c706197cc66f99b92e54a147678fc9a` | v | **W1+W2+ADJ** | los tres · es la SEDE CANÓNICA y `O21` nace en ella |
...
| 44 | `kernel/operativo/capacidades/CNS/CAPACIDAD.md` | 107 | `e0f79e6c3a467302c3d16aa5ee4ccb45583daf146d1676b2b06995419656c5d5` | ii | **DELEGADA** | AGOTADA POR DELEGACIÓN · su SHA-256 lo publicó el manifiesto del documento **30** · árbol `7aeed6a`. **Nadie declaró haberla leído íntegra en aquel gate** |
...
SOBRE EL ÁRBOL DE LA CANDIDATA
  ASIGNADAS A LECTURA        10   29348 líneas

...
def main():
    ...
    salida = []
    # `D-02` · el veredicto se calcula por separado y su materia prima existe aunque el
    # montaje reviente por el medio: una excepción deja a `T193` en rojo, no sin veredicto.
    codigo = 1
    ...
    try:
        ...
        if not recuperable or not sembrado:
            codigo = 1
    finally:
    ...
    # `D-02` · el escenario sale NOMBRADO con su veredicto, y no sólo con su título en la
    # cabecera y un recuento de pasos al final.
    salida.append("")
    salida.append("T193  %s  F6 · corte vertical 2 · veinticinco pasos del §12 del encargo"
                  % ("SUPERADA" if pasos_cumplidos and recuperable else "FALLIDA "))
